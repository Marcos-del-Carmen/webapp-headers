...
public class ProductosXlsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (esXls) {
            resp.setContentType("application/vnd.ms-excel"); // para que se pueda exportar a un excel.
            resp.setHeader("Content-Disposition", "attachment;filename=productos.xls"); // se fuerza la descarga y se le da un nombre a la misma.
        }
